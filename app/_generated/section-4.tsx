  ...
  return (
    <section data-eos-id="app/_generated/section-4.tsx#0" data-eos-v="2" className="px-6 py-20 sm:py-28" style={{ backgroundColor: t.surface, color: t.ink }}>
      <div data-eos-id="app/_generated/section-4.tsx#1" style={container(t)}>
        <div data-eos-id="app/_generated/section-4.tsx#2" className="mx-auto" style={{ maxWidth: '48rem' }}>
        <h2 data-eos-id="app/_generated/section-4.tsx#3" className="text-3xl font-semibold tracking-tight sm:text-4xl">{heading}</h2>
        <dl data-eos-id="app/_generated/section-4.tsx#4" className="mt-10">
          {items.map((item) => (
            <div data-eos-id="app/_generated/section-4.tsx#5" key={item.question} className="py-6" style={{ borderTop: '1px solid ' + t.line }}>
              <dt data-eos-id="app/_generated/section-4.tsx#6" data-eos-var="item.question" data-eos-var-label="Question" data-eos-var-scope="item" className="text-lg font-semibold">{item.question}</dt>
              <dd data-eos-id="app/_generated/section-4.tsx#7" data-eos-var="item.answer" data-eos-var-label="Answer" data-eos-var-scope="item" className="mt-2 leading-7" style={{ color: t.muted }}>
                {item.answer}
              </dd>
            </div>
          ))}
