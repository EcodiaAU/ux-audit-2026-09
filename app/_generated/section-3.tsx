  ...
  return (
    <section data-eos-id="app/_generated/section-3.tsx#0" data-eos-v="2" className="px-6 py-20 sm:py-28" style={{ backgroundColor: t.surface, color: t.ink }}>
      <div data-eos-id="app/_generated/section-3.tsx#1" style={container(t)}>
        ...
        <div data-eos-id="app/_generated/section-3.tsx#3" className="mt-12 grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
          {quotes.map((q) => (
            <figure data-eos-id="app/_generated/section-3.tsx#4"
              key={q.name}
              className="flex flex-col p-7"
              style={{ backgroundColor: t.surfaceAlt, border: '1px solid ' + t.line, borderRadius: t.radius }}
            >
              <blockquote data-eos-id="app/_generated/section-3.tsx#5" data-eos-var="q.quote" data-eos-var-label="Quote" data-eos-var-scope="item" className="flex-1 text-lg leading-7">{q.quote}</blockquote>
              <figcaption data-eos-id="app/_generated/section-3.tsx#6" className="mt-5 text-sm" style={{ color: t.muted }}>
                <span data-eos-id="app/_generated/section-3.tsx#7" data-eos-var="q.name" data-eos-var-label="Name" data-eos-var-scope="item" className="font-semibold" style={{ color: t.ink }}>{q.name}</span>
                {q.role ? <span data-eos-id="app/_generated/section-3.tsx#8" data-eos-var="q.role" data-eos-var-label="Role" data-eos-var-scope="item">, {q.role}</span> : null}
              </figcaption>
            </figure>
          ))}
        </div>
